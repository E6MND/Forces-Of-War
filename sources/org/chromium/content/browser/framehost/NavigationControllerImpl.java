...
class NavigationControllerImpl implements NavigationController {
    ...
    public void loadUrl(LoadUrlParams params) {
        ...
        if (this.mNativeNavigationControllerAndroid != 0) {
            ...
            nativeLoadUrl(j, url, loadUrlType, transitionType, str, i, params.getUserAgentOverrideOption(), params.getExtraHeadersString(), params.getPostData(), params.getBaseUrl(), params.getVirtualUrlForDataUrl(), params.getCanLoadLocalResources(), params.getIsRendererInitiated());
        }
    }
    ...
    @CalledByNative
    private static NavigationEntry createNavigationEntry(int index, String url, String virtualUrl, String originalUrl, String title, Bitmap favicon) {
