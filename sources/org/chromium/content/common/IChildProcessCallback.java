    ...
    public static abstract class Stub extends Binder implements IChildProcessCallback {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    SurfaceWrapper _result = getViewSurface(data.readInt());
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                ...
                case 3:
                    ...
                    registerSurfaceTextureSurface(_arg02, _arg12, _arg2);
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    SurfaceWrapper _result2 = getSurfaceTextureSurface(data.readInt());
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
