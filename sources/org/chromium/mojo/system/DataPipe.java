...
public interface DataPipe {
    ...
    public interface ConsumerHandle extends Handle {
        ...
        int readData(ByteBuffer byteBuffer, ReadFlags readFlags);
    }
    ...
    public interface ProducerHandle extends Handle {
        ...
        int writeData(ByteBuffer byteBuffer, WriteFlags writeFlags);
    }
    ...
    public static class CreateFlags extends Flags<CreateFlags> {
        ...
        public CreateFlags setMayDiscard(boolean mayDiscard) {
            return (CreateFlags) setFlag(1, mayDiscard);
        }
