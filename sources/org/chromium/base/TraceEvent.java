...
public class TraceEvent {
    ...
    private static class BasicLooperMonitor implements Printer {
        ...
        public void beginHandling(String line) {
        ...
        /* access modifiers changed from: package-private */
        public void endHandling(String line) {
            if (TraceEvent.sEnabled) {
    ...
    private static final class IdleTracingLooperMonitor extends BasicLooperMonitor implements MessageQueue.IdleHandler {
        ...
        /* access modifiers changed from: package-private */
        public final void beginHandling(String line) {
        ...
        /* access modifiers changed from: package-private */
        public final void endHandling(String line) {
    ...
    private static final class LooperMonitorHolder {
        /* access modifiers changed from: private */
        public static final BasicLooperMonitor sInstance = (CommandLine.getInstance().hasSwitch(BaseSwitches.ENABLE_IDLE_TRACING) ? new IdleTracingLooperMonitor() : new BasicLooperMonitor());
    ...
    public static void instant(String name) {
        if (sEnabled) {
            nativeInstant(name, (String) null);
        }
    }
    ...
    public static void startAsync(long id) {
        if (sEnabled) {
            nativeStartAsync(getCallerName(), id, (String) null);
        }
    }

    public static void startAsync(String name, long id) {
        if (sEnabled) {
            nativeStartAsync(name, id, (String) null);
        }
    }
    ...
    public static void finishAsync(long id) {
        if (sEnabled) {
            nativeFinishAsync(getCallerName(), id, (String) null);
        }
    }

    public static void finishAsync(String name, long id) {
        if (sEnabled) {
            nativeFinishAsync(name, id, (String) null);
        }
    }
    ...
    public static void begin() {
        if (sEnabled) {
            nativeBegin(getCallerName(), (String) null);
        }
    }

    public static void begin(String name) {
        if (sEnabled) {
            nativeBegin(name, (String) null);
        }
    }
    ...
    public static void end() {
        if (sEnabled) {
            nativeEnd(getCallerName(), (String) null);
        }
    }

    public static void end(String name) {
        if (sEnabled) {
            nativeEnd(name, (String) null);
        }
    }
