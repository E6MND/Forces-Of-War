...
public class Response {
    ...
    Response(Request request2, HttpURLConnection connection2, String rawResponse2, GraphObject graphObject2, boolean isFromCache2) {
        this(request2, connection2, rawResponse2, graphObject2, (GraphObjectList<GraphObject>) null, isFromCache2, (FacebookRequestError) null);
    }

    Response(Request request2, HttpURLConnection connection2, String rawResponse2, GraphObjectList<GraphObject> graphObjects, boolean isFromCache2) {
        this(request2, connection2, rawResponse2, (GraphObject) null, graphObjects, isFromCache2, (FacebookRequestError) null);
    }

    Response(Request request2, HttpURLConnection connection2, FacebookRequestError error2) {
        this(request2, connection2, (String) null, (GraphObject) null, (GraphObjectList<GraphObject>) null, false, error2);
    }

    Response(Request request2, HttpURLConnection connection2, String rawResponse2, GraphObject graphObject2, GraphObjectList<GraphObject> graphObjects, boolean isFromCache2, FacebookRequestError error2) {
    ...
    static List<Response> fromHttpConnection(HttpURLConnection connection2, RequestBatch requests) {
        ...
        try {
            ...
            constructErrorResponses = constructErrorResponses(requests, connection2, new FacebookException((Throwable) exception3));
        } finally {
            Utility.closeQuietly(stream2);
        }
        return constructErrorResponses;
    ...
    static List<Response> createResponsesFromStream(InputStream stream, HttpURLConnection connection2, RequestBatch requests, boolean isFromCache2) throws FacebookException, JSONException, IOException {
        ...
        return createResponsesFromString(responseString, connection2, requests, isFromCache2);
    }

    static List<Response> createResponsesFromString(String responseString, HttpURLConnection connection2, RequestBatch requests, boolean isFromCache2) throws FacebookException, JSONException, IOException {
    ...
    private static Response createResponseFromObject(Request request2, HttpURLConnection connection2, Object object, boolean isFromCache2, Object originalResult) throws JSONException {
        ...
        if (object instanceof JSONObject) {
            ...
            if (body instanceof JSONObject) {
                return new Response(request2, connection2, body.toString(), GraphObject.Factory.create((JSONObject) body), isFromCache2);
            } else if (body instanceof JSONArray) {
                return new Response(request2, connection2, body.toString(), GraphObject.Factory.createList((JSONArray) body, GraphObject.class), isFromCache2);
            } else {
                object = JSONObject.NULL;
            }
        }
        if (object == JSONObject.NULL) {
            return new Response(request2, connection2, object.toString(), (GraphObject) null, isFromCache2);
        }
