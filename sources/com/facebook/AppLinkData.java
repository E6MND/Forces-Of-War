...
public class AppLinkData {
    ...
    public static void fetchDeferredAppLinkFromServer(Context context, String applicationId, CompletionHandler completionHandler) {
        ...
        try {
            GraphObject wireResponse = Request.newPostRequest((Session) null, String.format(DEFERRED_APP_LINK_PATH, new Object[]{applicationId}), deferredApplinkParams, (Request.Callback) null).executeAndWait().getGraphObject();
