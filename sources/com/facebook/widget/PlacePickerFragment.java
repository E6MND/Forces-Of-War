...
public class PlacePickerFragment extends PickerFragment<GraphPlace> {
    ...
    public void setupViews(ViewGroup view) {
        if (this.showSearchBox) {
            ...
            listView.addHeaderView(getActivity().getLayoutInflater().inflate(R.layout.com_facebook_picker_search_box, listView, false), (Object) null, false);
    ...
    public void logAppEvents(boolean doneButtonClicked) {
        ...
        logger.logSdkEvent(AnalyticsEvents.EVENT_PLACE_PICKER_USAGE, (Double) null, parameters);
    }

    /* access modifiers changed from: package-private */
    public PickerFragment<GraphPlace>.PickerFragmentAdapter<GraphPlace> createAdapter() {
        PickerFragment<GraphPlace>.PickerFragmentAdapter<GraphPlace> adapter = new PickerFragment<GraphPlace>.PickerFragmentAdapter<GraphPlace>(getActivity()) {
