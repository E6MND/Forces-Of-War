...
public class ProfilePictureView extends FrameLayout {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (View.MeasureSpec.getMode(heightMeasureSpec) != 1073741824 && params.height == -2) {
            ...
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(newHeight, PageTransition.CLIENT_REDIRECT);
            customMeasure = true;
        }
        if (View.MeasureSpec.getMode(widthMeasureSpec) != 1073741824 && params.width == -2) {
            newWidth = getPresetSizeInPixels(true);
            widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(newWidth, PageTransition.CLIENT_REDIRECT);
            customMeasure = true;
        }
        if (customMeasure) {
