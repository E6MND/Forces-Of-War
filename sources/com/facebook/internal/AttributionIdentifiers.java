...
public class AttributionIdentifiers {
    ...
    public static AttributionIdentifiers getAttributionIdentifiers(Context context) {
        ...
        try {
            Cursor c = context.getContentResolver().query(ATTRIBUTION_ID_CONTENT_URI, new String[]{"aid", ANDROID_ID_COLUMN_NAME, LIMIT_TRACKING_COLUMN_NAME}, (String) null, (String[]) null, (String) null);
