...
public abstract class PlatformServiceClient implements ServiceConnection {
    ...
    public boolean start() {
        Intent intent;
        if (this.running || NativeProtocol.getLatestAvailableProtocolVersionForService(this.context, this.protocolVersion) == -1 || (intent = NativeProtocol.createPlatformServiceIntent(this.context)) == null) {
            return false;
        }
        this.running = true;
