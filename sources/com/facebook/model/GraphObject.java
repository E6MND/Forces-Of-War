            ...
            if (value != null) {
                ...
                if (GraphObject.class.isAssignableFrom(expectedType)) {
                    ...
                    if (String.class.equals(expectedType)) {
                        ...
                        while (i$ < len$) {
                            try {
                                Date date = arr$[i$].parse((String) value);
                                if (date != null) {
                                    return date;
                                }
                                i$++;
            ...
            private final Object proxyGraphObjectMethods(Object proxy, Method method, Object[] args) {
                ...
                if (methodName.equals(CAST_METHOD)) {
                    ...
                    if (methodName.equals(GETPROPERTYAS_METHOD)) {
                        return Factory.coerceValueToExpectedType(((JSONObject) this.state).opt(args[0]), args[1], (ParameterizedType) null);
                    }
                    if (methodName.equals(GETPROPERTYASLIST_METHOD)) {
                        Object value = ((JSONObject) this.state).opt(args[0]);
                        final Class<?> expectedType = args[1];
                        return Factory.coerceValueToExpectedType(value, GraphObjectList.class, new ParameterizedType() {
