...
public class Facebook {
    ...
    public String request(Bundle parameters) throws MalformedURLException, IOException {
        if (parameters.containsKey("method")) {
            return requestImpl((String) null, parameters, "GET");
        }
    ...
    public void dialog(Context context, String action, Bundle parameters, DialogListener listener) {
        ...
        if (action.equals(LOGIN)) {
            parameters.putString(MessagingSmsConsts.TYPE, "user_agent");
    ...
    public final com.facebook.Session getSession() {
        ...
        L_0x0002:
            ...
            monitor-enter(r10)
            com.facebook.Session r7 = r11.userSetSession     // Catch:{ all -> 0x001b }
            if (r7 == 0) goto L_0x000f
            com.facebook.Session r6 = r11.userSetSession     // Catch:{ all -> 0x001b }
            monitor-exit(r10)     // Catch:{ all -> 0x001b }
        L_0x000e:
            return r6
        L_0x000f:
            com.facebook.Session r7 = r11.session     // Catch:{ all -> 0x001b }
            if (r7 != 0) goto L_0x0017
            boolean r7 = r11.sessionInvalidated     // Catch:{ all -> 0x001b }
            if (r7 != 0) goto L_0x001e
        L_0x0017:
            com.facebook.Session r6 = r11.session     // Catch:{ all -> 0x001b }
            monitor-exit(r10)     // Catch:{ all -> 0x001b }
            goto L_0x000e
        L_0x001b:
            r7 = move-exception
            ...
            throw r7
        L_0x001e:
            java.lang.String r0 = r11.accessToken     // Catch:{ all -> 0x001b }
            com.facebook.Session r3 = r11.session     // Catch:{ all -> 0x001b }
            monitor-exit(r10)     // Catch:{ all -> 0x001b }
        ...
        L_0x0027:
            ...
            java.util.List r5 = r3.getPermissions()
        L_0x002d:
            com.facebook.Session$Builder r7 = new com.facebook.Session$Builder
            android.app.Activity r10 = r11.pendingAuthorizationActivity
            r7.<init>(r10)
            java.lang.String r10 = r11.mAppId
            com.facebook.Session$Builder r7 = r7.setApplicationId(r10)
            com.facebook.TokenCachingStrategy r10 = r11.getTokenCache()
            com.facebook.Session$Builder r7 = r7.setTokenCachingStrategy(r10)
            com.facebook.Session r2 = r7.build()
            com.facebook.SessionState r7 = r2.getState()
            com.facebook.SessionState r10 = com.facebook.SessionState.CREATED_TOKEN_LOADED
            if (r7 == r10) goto L_0x0060
            r6 = r9
            goto L_0x000e
        L_0x0050:
            java.lang.String[] r7 = r11.pendingAuthorizationPermissions
        ...
        L_0x005b:
            ...
            goto L_0x002d
        L_0x0060:
            com.facebook.Session$OpenRequest r7 = new com.facebook.Session$OpenRequest
            android.app.Activity r10 = r11.pendingAuthorizationActivity
            r7.<init>((android.app.Activity) r10)
            com.facebook.Session$OpenRequest r4 = r7.setPermissions((java.util.List) r5)
        ...
        L_0x0072:
            ...
            java.lang.Object r10 = r11.lock
            monitor-enter(r10)
            boolean r7 = r11.sessionInvalidated     // Catch:{ all -> 0x0096 }
            if (r7 != 0) goto L_0x0082
            com.facebook.Session r7 = r11.session     // Catch:{ all -> 0x0096 }
            if (r7 != 0) goto L_0x008a
        L_0x0082:
            com.facebook.Session r1 = r11.session     // Catch:{ all -> 0x0096 }
    ...
    public void setAccessExpiresIn(String expiresInSecsFromNow) {
        ...
        if (expiresInSecsFromNow != null) {
            setAccessExpires(expiresInSecsFromNow.equals(AppEventsConstants.EVENT_PARAM_VALUE_NO) ? 0 : System.currentTimeMillis() + (Long.parseLong(expiresInSecsFromNow) * 1000));
        }
    }
