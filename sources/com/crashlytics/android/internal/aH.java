...
final class aH implements X509TrustManager {
    ...
    public aH(aI aIVar, aG aGVar) {
        this.a = a(aIVar);
        this.b = aIVar;
        this.c = -1;
        for (String a2 : aGVar.c()) {
            this.d.add(a(a2));
        }
    }

    private static TrustManager[] a(aI aIVar) {
        try {
            TrustManagerFactory instance = TrustManagerFactory.getInstance("X509");
            instance.init(aIVar.a);
    ...
    public final void checkServerTrusted(X509Certificate[] chain, String authType) throws CertificateException {
        if (!this.e.contains(chain[0])) {
            ...
            C0188v.a().b().c(Crashlytics.TAG, "Certificate pins are stale, (" + (System.currentTimeMillis() - this.c) + " millis vs 15552000000" + " millis) falling back to system trust.");
            this.e.add(chain[0]);
        }
    }
