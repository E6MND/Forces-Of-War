...
public class IabHelper {
    ...
    public static final int BILLING_RESPONSE_RESULT_REFUNDED = 2;
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, int requestCode, OnIabPurchaseFinishedListener listener, String extraData) {
        ...
        if (!itemType.equals(ITEM_TYPE_SUBS) || this.mSubscriptionsSupported) {
            try {
                ...
                logError("RemoteException while launching purchase flow for sku " + sku, e2);
    ...
    public void logError(String msg) {
        logError(msg, (Exception) null);
    }

    /* access modifiers changed from: package-private */
    public void logError(String msg, Exception e) {
        String logMsg = "In-app billing error: " + msg;
        Log.e(this.mDebugTag, logMsg);
        Utils.logUkenEvent(this.mDebugTag, logMsg, e);
    }

    /* access modifiers changed from: package-private */
    public void logWarn(String msg) {
        String logMsg = "In-app billing warning: " + msg;
        Log.w(this.mDebugTag, logMsg);
        Utils.logUkenEvent(this.mDebugTag, logMsg);
    }
}
