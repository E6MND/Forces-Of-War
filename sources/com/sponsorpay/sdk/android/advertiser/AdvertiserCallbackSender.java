...
public class AdvertiserCallbackSender extends AsyncTask<String, Void, Boolean> {
    ...
    public void trigger() {
        execute(new String[]{buildUrl()});
    }

    private String buildUrl() {
        String baseUrl;
        if (SponsorPayAdvertiser.shouldUseStagingUrls()) {
            baseUrl = API_STAGING_RESOURCE_URL;
        } else {
            baseUrl = API_PRODUCTION_RESOURCE_URL;
        }
        String[] strArr = {SUCCESSFUL_ANSWER_RECEIVED_KEY};
        String[] strArr2 = new String[1];
        strArr2[0] = this.mWasAlreadySuccessful ? AppEventsConstants.EVENT_PARAM_VALUE_YES : AppEventsConstants.EVENT_PARAM_VALUE_NO;
    ...
    public Boolean doInBackground(String... params) {
        boolean returnValue;
        this.mHttpRequest = new HttpGet(params[0]);
