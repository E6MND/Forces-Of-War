...
public class InstallReferrerReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.i(getClass().getSimpleName(), "Received install referrer. Persisting data. Package name: " + context.getPackageName() + ". Install referrer: " + referrer);
        ...
        Log.i(getClass().getSimpleName(), "SubID extracted from received referrer: " + contentParameterSubId);
