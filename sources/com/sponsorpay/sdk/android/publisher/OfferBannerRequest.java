...
public class OfferBannerRequest implements AsyncRequest.AsyncRequestResultListener {
    ...
    private void requestOfferBanner() {
        Map<String, String> extraKeysValues = UrlBuilder.mapKeysToValues(new String[]{URL_PARAM_OFFERBANNER_KEY, UrlBuilder.URL_PARAM_ALLOW_CAMPAIGN_KEY, UrlBuilder.URL_PARAM_OFFSET_KEY}, new String[]{UrlBuilder.URL_PARAM_VALUE_ON, UrlBuilder.URL_PARAM_VALUE_ON, String.valueOf(fetchPersistedBannerOffset())});
    ...
    private void incrementPersistedBannerOffset() {
        ...
        prefs.edit().putInt(STATE_OFFSET_COUNT_KEY, fetchPersistedBannerOffset(prefs) + 1).commit();
    }
