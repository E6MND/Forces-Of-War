...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            hn.a(plusClient != null, "PlusClient must not be null.");
            hn.a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            hn.a(plusClient.jN().by(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            ...
            hn.b(uri != null && !TextUtils.isEmpty(uri.toString()), (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                hn.a(PlusShare.bv(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Builder addStream(Uri streamUri) {
            ...
            this.abF.add(uri);
            this.abF.add(streamUri);
            return this;
        }

        public Intent getIntent() {
            boolean z = true;
            boolean z2 = this.abF != null && this.abF.size() > 1;
            ...
            hn.a(!z2 || !booleanExtra, "Call-to-action buttons are only available for URLs.");
            hn.a(!booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL), "The content URL is required for interactive posts.");
            ...
            hn.a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                hn.a(PlusShare.bv(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
                ...
                if (this.abF == null || this.abF.isEmpty()) {
                    ...
                    this.mIntent.putExtra("android.intent.extra.STREAM", this.abF.get(0));
                }
                this.abF = null;
            }
            if (z2 && !equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            hn.b(this.abE, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            hn.b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
    ...
    protected static boolean bv(String str) {
        if (TextUtils.isEmpty(str)) {
    ...
    public static Person createPerson(String id, String displayName) {
        if (TextUtils.isEmpty(id)) {
            ...
            return new kt(displayName, id, (kt.c) null, 0, (String) null);
        } else {
