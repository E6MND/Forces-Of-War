...
public interface lq extends IInterface {
    ...
    public static abstract class a extends Binder implements lq {

        /* renamed from: com.google.android.gms.internal.lq$a$a  reason: collision with other inner class name */
        private static class C0078a implements lq {
            private IBinder ko;
            ...
            public void a(Status status, lj ljVar, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.wallet.internal.IWalletServiceCallbacks");
        ...
        public static lq bt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof lq)) ? new C0078a(iBinder) : (lq) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 5:
                    data.enforceInterface("com.google.android.gms.wallet.internal.IWalletServiceCallbacks");
                    a(data.readInt() != 0 ? Status.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? lj.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void a(Status status, lj ljVar, Bundle bundle) throws RemoteException;
