...
public interface lm extends IInterface {
    ...
    public static abstract class a extends Binder implements lm {
        ...
        /* renamed from: com.google.android.gms.internal.lm$a$a  reason: collision with other inner class name */
        private static class C0074a implements lm {
            private IBinder ko;
        ...
        public static lm bp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof lm)) ? new C0074a(iBinder) : (lm) queryLocalInterface;
        }
