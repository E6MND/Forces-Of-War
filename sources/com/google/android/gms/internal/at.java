...
public interface at extends IInterface {
    ...
    public static abstract class a extends Binder implements at {
        ...
        /* renamed from: com.google.android.gms.internal.at$a$a  reason: collision with other inner class name */
        private static class C0037a implements at {
            private IBinder ko;
        ...
        public static at h(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof at)) ? new C0037a(iBinder) : (at) queryLocalInterface;
        }
