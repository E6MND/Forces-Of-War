...
public interface iy extends IInterface {
    ...
    public static abstract class a extends Binder implements iy {
        ...
        /* renamed from: com.google.android.gms.internal.iy$a$a  reason: collision with other inner class name */
        private static class C0065a implements iy {
            private IBinder ko;
        ...
        public static iy ao(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof iy)) ? new C0065a(iBinder) : (iy) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    g(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
