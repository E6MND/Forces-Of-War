...
public class hr<K, V> {
    ...
    public final V get(K r5) {
        ...
        L_0x000a:
            monitor-enter(r4)
            java.util.LinkedHashMap<K, V> r0 = r4.GJ     // Catch:{ all -> 0x002a }
            java.lang.Object r0 = r0.get(r5)     // Catch:{ all -> 0x002a }
            if (r0 == 0) goto L_0x001b
            int r1 = r4.GO     // Catch:{ all -> 0x002a }
            int r1 = r1 + 1
            r4.GO = r1     // Catch:{ all -> 0x002a }
            monitor-exit(r4)     // Catch:{ all -> 0x002a }
        L_0x001a:
            return r0
        L_0x001b:
            int r0 = r4.GP     // Catch:{ all -> 0x002a }
            int r0 = r0 + 1
            r4.GP = r0     // Catch:{ all -> 0x002a }
            monitor-exit(r4)     // Catch:{ all -> 0x002a }
        ...
        L_0x002d:
            monitor-enter(r4)
            int r0 = r4.GM     // Catch:{ all -> 0x0053 }
            int r0 = r0 + 1
            r4.GM = r0     // Catch:{ all -> 0x0053 }
            java.util.LinkedHashMap<K, V> r0 = r4.GJ     // Catch:{ all -> 0x0053 }
            java.lang.Object r0 = r0.put(r5, r1)     // Catch:{ all -> 0x0053 }
            if (r0 == 0) goto L_0x0049
            java.util.LinkedHashMap<K, V> r2 = r4.GJ     // Catch:{ all -> 0x0053 }
        ...
        L_0x0056:
            ...
            goto L_0x001a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.hr.get(java.lang.Object):java.lang.Object");
    }
    ...
    public final synchronized String toString() {
        ...
        int i = 0;
        synchronized (this) {
            int i2 = this.GO + this.GP;
            if (i2 != 0) {
                i = (this.GO * 100) / i2;
            }
            format = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.GK), Integer.valueOf(this.GO), Integer.valueOf(this.GP), Integer.valueOf(i)});
        }
        return format;
    }
    ...
    public void trimToSize(int r5) {
        ...
        L_0x0000:
            ...
            java.util.LinkedHashMap<K, V> r0 = r4.GJ     // Catch:{ all -> 0x0032 }
        ...
        L_0x0043:
            ...
            java.util.LinkedHashMap<K, V> r2 = r4.GJ     // Catch:{ all -> 0x0032 }
            r2.remove(r1)     // Catch:{ all -> 0x0032 }
            int r2 = r4.size     // Catch:{ all -> 0x0032 }
            int r3 = r4.c(r1, r0)     // Catch:{ all -> 0x0032 }
            int r2 = r2 - r3
            r4.size = r2     // Catch:{ all -> 0x0032 }
            int r2 = r4.GN     // Catch:{ all -> 0x0032 }
            int r2 = r2 + 1
            r4.GN = r2     // Catch:{ all -> 0x0032 }
            monitor-exit(r4)     // Catch:{ all -> 0x0032 }
            r2 = 1
            r3 = 0
            ...
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.hr.trimToSize(int):void");
    }
}
