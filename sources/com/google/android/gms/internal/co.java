...
public interface co extends IInterface {
    ...
    public static abstract class a extends Binder implements co {
        ...
        private static class C0042a implements co {
            private IBinder ko;
        ...
        public static co m(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.overlay.client.IAdOverlay");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof co)) ? new C0042a(iBinder) : (co) queryLocalInterface;
        }
