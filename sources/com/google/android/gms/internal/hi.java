...
public interface hi extends IInterface {
    ...
    public static abstract class a extends Binder implements hi {
        ...
        private static class C0061a implements hi {
            private IBinder ko;
        ...
        public static hi K(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.IGmsCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hi)) ? new C0061a(iBinder) : (hi) queryLocalInterface;
        }
