...
public interface bw extends IInterface {
    ...
    public static abstract class a extends Binder implements bw {
        ...
        private static class C0040a implements bw {
            private IBinder ko;
        ...
        public static bw k(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bw)) ? new C0040a(iBinder) : (bw) queryLocalInterface;
        }
