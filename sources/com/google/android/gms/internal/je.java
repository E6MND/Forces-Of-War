...
public interface je extends IInterface {
    ...
    public static abstract class a extends Binder implements je {
        ...
        private static class C0067a implements je {
            private IBinder ko;
        ...
        public static je ar(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof je)) ? new C0067a(iBinder) : (je) queryLocalInterface;
        }
