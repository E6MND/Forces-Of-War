...
public interface hk extends IInterface {
    ...
    public static abstract class a extends Binder implements hk {
        ...
        private static class C0063a implements hk {
            private IBinder ko;
        ...
        public static hk M(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.ISignInButtonCreator");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hk)) ? new C0063a(iBinder) : (hk) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    d a = a(d.a.ag(data.readStrongBinder()), data.readInt(), data.readInt());
