...
public interface ll extends IInterface {
    ...
    public static abstract class a extends Binder implements ll {
        ...
        /* renamed from: com.google.android.gms.internal.ll$a$a  reason: collision with other inner class name */
        private static class C0073a implements ll {
            private IBinder ko;
        ...
        public static ll bo(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ll)) ? new C0073a(iBinder) : (ll) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    a(d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? WalletFragmentOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
