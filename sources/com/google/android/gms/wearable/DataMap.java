...
public class DataMap {
    ...
    public static DataMap fromByteArray(byte[] bytes) {
        try {
            return lw.a(new lw.a(lx.n(bytes), new ArrayList()));
        } catch (me e) {
    ...
    public boolean containsKey(String key) {
        return this.alh.containsKey(key);
    }
    ...
    public boolean equals(Object o) {
        ...
        return a(this, (DataMap) o);
    }

    public <T> T get(String key) {
        return this.alh.get(key);
    }

    public Asset getAsset(String key) {
        Object obj = this.alh.get(key);
        if (obj == null) {
            return null;
        }
        try {
    ...
    public void putAll(DataMap dataMap) {
        for (String next : dataMap.keySet()) {
            this.alh.put(next, dataMap.get(next));
        }
    }

    public void putAsset(String key, Asset value) {
        this.alh.put(key, value);
    }

    public void putBoolean(String key, boolean value) {
        this.alh.put(key, Boolean.valueOf(value));
    }

    public void putByte(String key, byte value) {
        this.alh.put(key, Byte.valueOf(value));
    }
    ...
    public void putDouble(String key, double value) {
        this.alh.put(key, Double.valueOf(value));
    }

    public void putFloat(String key, float value) {
        this.alh.put(key, Float.valueOf(value));
    }
    ...
    public void putInt(String key, int value) {
        this.alh.put(key, Integer.valueOf(value));
    }
    ...
    public void putLong(String key, long value) {
        this.alh.put(key, Long.valueOf(value));
    }
    ...
    public Bundle toBundle() {
        ...
        for (String next : this.alh.keySet()) {
            a(bundle, next, this.alh.get(next));
        }
        return bundle;
    }
