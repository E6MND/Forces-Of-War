...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IPolylineDelegate {
        ...
        private static class C0113a implements IPolylineDelegate {
            private IBinder ko;
        ...
        public static IPolylineDelegate be(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPolylineDelegate)) ? new C0113a(iBinder) : (IPolylineDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 15:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    boolean equalsRemote = equalsRemote(be(data.readStrongBinder()));
                    reply.writeNoException();
                    if (equalsRemote) {
                        z = true;
                    }
