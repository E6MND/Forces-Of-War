...
public interface h extends IInterface {
    ...
    public static abstract class a extends Binder implements h {
        ...
        private static class C0122a implements h {
            private IBinder ko;
        ...
        public static h bf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof h)) ? new C0122a(iBinder) : (h) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    boolean a = a(bf(data.readStrongBinder()));
                    reply.writeNoException();
                    if (a) {
                        z = true;
                    }
