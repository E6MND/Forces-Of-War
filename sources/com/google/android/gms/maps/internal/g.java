...
public interface g extends IInterface {
    ...
    public static abstract class a extends Binder implements g {
        ...
        private static class C0100a implements g {
            private IBinder ko;
        ...
        public static g aF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof g)) ? new C0100a(iBinder) : (g) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    e(f.a.bc(data.readStrongBinder()));
