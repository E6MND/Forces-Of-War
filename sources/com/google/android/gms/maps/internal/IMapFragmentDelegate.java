...
public interface IMapFragmentDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IMapFragmentDelegate {
        ...
        private static class C0088a implements IMapFragmentDelegate {
            private IBinder ko;
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    ...
                    return IGoogleMapDelegate.a.ay(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public void onInflate(d activityWrapper, GoogleMapOptions options, Bundle savedInstanceState) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        ...
        public static IMapFragmentDelegate aB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapFragmentDelegate)) ? new C0088a(iBinder) : (IMapFragmentDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    onInflate(d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? GoogleMapOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                ...
                case 4:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    d onCreateView = onCreateView(d.a.ag(data.readStrongBinder()), d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
    ...
    void onInflate(d dVar, GoogleMapOptions googleMapOptions, Bundle bundle) throws RemoteException;
