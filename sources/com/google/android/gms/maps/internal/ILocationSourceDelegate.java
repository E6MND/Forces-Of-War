...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements ILocationSourceDelegate {
        ...
        private static class C0087a implements ILocationSourceDelegate {
            private IBinder ko;
        ...
        public static ILocationSourceDelegate aA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C0087a(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    activate(h.a.aG(data.readStrongBinder()));
