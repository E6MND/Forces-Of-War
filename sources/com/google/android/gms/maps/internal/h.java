...
public interface h extends IInterface {
    ...
    public static abstract class a extends Binder implements h {
        ...
        private static class C0101a implements h {
            private IBinder ko;
        ...
        public static h aG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof h)) ? new C0101a(iBinder) : (h) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    k(d.a.ag(data.readStrongBinder()));
