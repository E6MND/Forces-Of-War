...
public interface q extends IInterface {
    ...
    public static abstract class a extends Binder implements q {
        ...
        /* renamed from: com.google.android.gms.maps.internal.q$a$a  reason: collision with other inner class name */
        private static class C0110a implements q {
            private IBinder ko;
        ...
        public static q aP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof q)) ? new C0110a(iBinder) : (q) queryLocalInterface;
        }
