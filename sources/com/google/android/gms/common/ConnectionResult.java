...
public final class ConnectionResult {
    ...
    public static final ConnectionResult CP = new ConnectionResult(0, (PendingIntent) null);
    ...
    private String es() {
        switch (this.CQ) {
            ...
            case 15:
                return "INTERRUPTED";
            default:
                return "unknown status code " + this.CQ;
        }
    }
    ...
    public boolean hasResolution() {
        return (this.CQ == 0 || this.mPendingIntent == null) ? false : true;
    }
