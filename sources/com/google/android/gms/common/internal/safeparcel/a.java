...
public class a {
    ...
    public static class C0014a extends RuntimeException {
        public C0014a(String str, Parcel parcel) {
    ...
    public static int B(Parcel parcel) {
        ...
        int dataPosition = parcel.dataPosition();
        if (ar(A) != 20293) {
            throw new C0014a("Expected object header. Got 0x" + Integer.toHexString(A), parcel);
        }
        int i = dataPosition + a;
        if (i >= dataPosition && i <= parcel.dataSize()) {
            return i;
        }
        throw new C0014a("Size read is invalid start=" + dataPosition + " end=" + i, parcel);
    }
    ...
    private static void a(Parcel parcel, int i, int i2) {
        int a = a(parcel, i);
        if (a != i2) {
            throw new C0014a("Expected size " + i2 + " got " + a + " (0x" + Integer.toHexString(a) + ")", parcel);
        }
    }

    private static void a(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            throw new C0014a("Expected size " + i3 + " got " + i2 + " (0x" + Integer.toHexString(i2) + ")", parcel);
        }
    }
