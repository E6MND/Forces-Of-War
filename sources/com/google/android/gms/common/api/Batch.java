...
public final class Batch extends a.C0011a<BatchResult> {
    ...
    private Batch(List<PendingResult<?>> pendingResultList, Looper looper) {
        ...
        this.lq = new Object();
        this.Dw = pendingResultList.size();
                ...
                pendingResult.a(new PendingResult.a() {
                    ...
                    public void n(com.google.android.gms.common.api.Status r6) {
                        ...
                        L_0x0011:
                            ...
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            r2 = 1
                            boolean unused = r0.Dy = r2     // Catch:{ all -> 0x0039 }
                        L_0x001d:
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            com.google.android.gms.common.api.Batch.b(r0)     // Catch:{ all -> 0x0039 }
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            int r0 = r0.Dw     // Catch:{ all -> 0x0039 }
                            if (r0 != 0) goto L_0x0037
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            boolean r0 = r0.Dy     // Catch:{ all -> 0x0039 }
                        ...
                        L_0x003c:
                            ...
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            r2 = 1
                            boolean unused = r0.Dx = r2     // Catch:{ all -> 0x0039 }
                            goto L_0x001d
                        L_0x0049:
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            boolean r0 = r0.Dx     // Catch:{ all -> 0x0039 }
                        ...
                        L_0x0058:
                            ...
                            com.google.android.gms.common.api.PendingResult[] r4 = r4.Dz     // Catch:{ all -> 0x0039 }
                            r3.<init>(r0, r4)     // Catch:{ all -> 0x0039 }
                            r2.a(r3)     // Catch:{ all -> 0x0039 }
                            goto L_0x0037
                        L_0x0069:
                            com.google.android.gms.common.api.Status r0 = com.google.android.gms.common.api.Status.Ek     // Catch:{ all -> 0x0039 }
                            goto L_0x0058
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.api.Batch.AnonymousClass1.n(com.google.android.gms.common.api.Status):void");
                    }
                });
                i = i2 + 1;
            } else {
    ...
    public void cancel() {
        super.cancel();
        for (PendingResult<?> cancel : this.Dz) {
            cancel.cancel();
        }
    }
