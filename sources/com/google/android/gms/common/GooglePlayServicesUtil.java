...
public final class GooglePlayServicesUtil {
    ...
    public static Intent Z(int i) {
        switch (i) {
            case 1:
            case 2:
                return hf.aD(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
                return hf.aB(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 12:
                return hf.fv();
            default:
                return null;
    ...
    private static android.app.Dialog a(int r5, android.app.Activity r6, android.support.v4.app.Fragment r7, int r8, android.content.DialogInterface.OnCancelListener r9) {
        /*
            r2 = 0
            boolean r0 = com.google.android.gms.internal.iq.ga()
        ...
        L_0x002f:
            ...
            r0.<init>(r6)
        L_0x0036:
            java.lang.String r1 = d(r6, r5)
            r0.setMessage(r1)
            if (r9 == 0) goto L_0x0042
            r0.setOnCancelListener(r9)
        L_0x0042:
            android.content.Intent r3 = c(r6, r5)
            if (r7 != 0) goto L_0x0076
            com.google.android.gms.internal.ha r1 = new com.google.android.gms.internal.ha
            r1.<init>((android.app.Activity) r6, (android.content.Intent) r3, (int) r8)
        L_0x004d:
            java.lang.String r3 = e(r6, r5)
        ...
        L_0x0076:
            com.google.android.gms.internal.ha r1 = new com.google.android.gms.internal.ha
            r1.<init>((android.support.v4.app.Fragment) r7, (android.content.Intent) r3, (int) r8)
            goto L_0x004d
        L_0x007c:
            r0 = r2
            goto L_0x0075
        L_0x007e:
            ...
            goto L_0x0075
        L_0x0083:
            int r1 = com.google.android.gms.R.string.common_google_play_services_install_title
            android.app.AlertDialog$Builder r0 = r0.setTitle(r1)
            android.app.AlertDialog r0 = r0.create()
            goto L_0x0075
        L_0x008e:
            int r1 = com.google.android.gms.R.string.common_google_play_services_enable_title
            android.app.AlertDialog$Builder r0 = r0.setTitle(r1)
            android.app.AlertDialog r0 = r0.create()
            goto L_0x0075
        L_0x0099:
            int r1 = com.google.android.gms.R.string.common_google_play_services_update_title
            android.app.AlertDialog$Builder r0 = r0.setTitle(r1)
            android.app.AlertDialog r0 = r0.create()
            goto L_0x0075
        L_0x00a4:
            ...
            android.util.Log.e(r1, r2)
            int r1 = com.google.android.gms.R.string.common_google_play_services_unsupported_title
            android.app.AlertDialog$Builder r0 = r0.setTitle(r1)
            android.app.AlertDialog r0 = r0.create()
            goto L_0x0075
        L_0x00b6:
            ...
            android.util.Log.e(r1, r2)
            int r1 = com.google.android.gms.R.string.common_google_play_services_network_error_title
            android.app.AlertDialog$Builder r0 = r0.setTitle(r1)
            android.app.AlertDialog r0 = r0.create()
            goto L_0x0075
        L_0x00c8:
        ...
        L_0x00e0:
            ...
            android.util.Log.e(r1, r2)
            int r1 = com.google.android.gms.R.string.common_google_play_services_invalid_account_title
            android.app.AlertDialog$Builder r0 = r0.setTitle(r1)
            android.app.AlertDialog r0 = r0.create()
            goto L_0x0075
        L_0x00f2:
        ...
        L_0x00ff:
            java.lang.String r1 = "GooglePlayServicesUtil"
            java.lang.String r2 = "The date of the device is not valid."
            android.util.Log.e(r1, r2)
            int r1 = com.google.android.gms.R.string.common_google_play_services_unsupported_title
            android.app.AlertDialog$Builder r0 = r0.setTitle(r1)
            android.app.AlertDialog r0 = r0.create()
    ...
    public static boolean a(PackageManager packageManager, PackageInfo packageInfo) {
        ...
        if (c(packageManager)) {
            if (a(packageInfo, Da) == null) {
                z = false;
            }
            return z;
        }
        if (a(packageInfo, Db) != null) {
            z2 = true;
        }
        if (z2 || a(packageInfo, Da) == null) {
            return z2;
        }
    ...
    public static boolean a(Resources resources) {
        ...
        return (iq.fX() && ((resources.getConfiguration().screenLayout & 15) > 3)) || b(resources);
    }
    ...
    private static byte[] a(PackageInfo packageInfo, byte[]... bArr) {
        try {
            ...
            try {
                try {
                    ((X509Certificate) instance.generateCertificate(new ByteArrayInputStream(byteArray))).checkValidity();
                    for (byte[] bArr2 : bArr) {
    ...
    public static boolean b(PackageManager packageManager) {
        synchronized (Df) {
            if (De == -1) {
                try {
                    if (a(packageManager.getPackageInfo(GOOGLE_PLAY_SERVICES_PACKAGE, 64), Da[1]) != null) {
                        De = 1;
                    } else {
                        De = 0;
                    }
    ...
    private static boolean b(Resources resources) {
        ...
        return iq.fZ() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }
    ...
    public static boolean et() {
        return Dc ? Dd : "user".equals(Build.TYPE);
    }
    ...
    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, DialogInterface.OnCancelListener cancelListener) {
        return a(errorCode, activity, (Fragment) null, requestCode, cancelListener);
    }
    ...
    public static PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
        ...
        return PendingIntent.getActivity(context, requestCode, c, 268435456);
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            ...
            } else if (!ij.C(context)) {
                try {
                    byte[] a = a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), CS);
                    if (a == null) {
            ...
            } else if (a(packageInfo, CS) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
            if (ij.aB(packageInfo.versionCode) < ij.aB(GOOGLE_PLAY_SERVICES_VERSION_CODE)) {
                Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 5077000 but found " + packageInfo.versionCode);
                return 2;
            }
            try {
    ...
    public static boolean showErrorDialogFragment(int errorCode, Activity activity, int requestCode, DialogInterface.OnCancelListener cancelListener) {
        return b(errorCode, activity, (Fragment) null, requestCode, cancelListener);
    }
    ...
    public static void showErrorNotification(int errorCode, Context context) {
        ...
        notification.setLatestEventInfo(context, f(context, errorCode), resources.getString(R.string.common_google_play_services_error_notification_requested_by_msg, new Object[]{y(context)}), getErrorPendingIntent(errorCode, context, 0));
        ((NotificationManager) context.getSystemService("notification")).notify(39789, notification);
    }

    public static void w(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
