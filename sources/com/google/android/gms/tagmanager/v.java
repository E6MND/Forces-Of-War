...
class v implements DataLayer.c {
    ...
    public static final String afg = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' STRING NOT NULL, '%s' BLOB NOT NULL, '%s' INTEGER NOT NULL);", new Object[]{"datalayer", "ID", "key", "value", "expires"});
    private ik aec;
    ...
    public v(Context context) {
        this(context, im.fW(), "google_tagmanager.db", 2000, Executors.newSingleThreadExecutor());
    }

    v(Context context, ik ikVar, String str, int i, Executor executor) {
        this.mContext = context;
        this.aec = ikVar;
        this.afj = i;
        this.afh = executor;
        this.afi = new a(this.mContext, str);
    }

    private SQLiteDatabase S(String str) {
        try {
            return this.afi.getWritableDatabase();
        } catch (SQLiteException e) {
            bh.D(str);
            return null;
        }
    ...
    private void c(List<b> list, long j) {
        ...
        if (S != null) {
            for (b next : list) {
                ...
                contentValues.put("key", next.JI);
                contentValues.put("value", next.afp);
                S.insert("datalayer", (String) null, contentValues);
            }
        }
    }
    ...
    private void m3do(int i) {
        int lz = (lz() - this.afj) + i;
        if (lz > 0) {
            List<String> dp = dp(lz);
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.List<java.lang.String> dp(int r14) {
        /*
            r13 = this;
            r10 = 0
        ...
        L_0x0088:
            ...
            goto L_0x005e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.v.dp(int):java.util.List");
    }

    private List<DataLayer.a> e(List<b> list) {
        ArrayList arrayList = new ArrayList();
        for (b next : list) {
            arrayList.add(new DataLayer.a(next.JI, j(next.afp)));
        }
        return arrayList;
    }

    private List<b> f(List<DataLayer.a> list) {
        ArrayList arrayList = new ArrayList();
        for (DataLayer.a next : list) {
            arrayList.add(new b(next.JI, j(next.afe)));
        }
        return arrayList;
    }
    ...
    private void g(String[] strArr) {
        SQLiteDatabase S;
        if (strArr != null && strArr.length != 0 && (S = S("Error opening database for deleteEntries.")) != null) {
            try {
    ...
    private List<b> ly() {
        ...
        Cursor query = S.query("datalayer", new String[]{"key", "value"}, (String) null, (String[]) null, (String) null, (String) null, "ID", (String) null);
    ...
    private int lz() {
        ...
        if (S != null) {
            try {
                Cursor rawQuery = S.rawQuery("SELECT COUNT(*) from datalayer", (String[]) null);
