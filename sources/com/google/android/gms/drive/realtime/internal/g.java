...
public interface g extends IInterface {
    ...
    public static abstract class a extends Binder implements g {
        ...
        /* renamed from: com.google.android.gms.drive.realtime.internal.g$a$a  reason: collision with other inner class name */
        private static class C0022a implements g {
            private IBinder ko;
        ...
        public static g W(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof g)) ? new C0022a(iBinder) : (g) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    a(data.readInt() != 0 ? DataHolder.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? ParcelableEventList.CREATOR.createFromParcel(data) : null);
    ...
    void a(DataHolder dataHolder, ParcelableEventList parcelableEventList) throws RemoteException;
