...
public class p implements Parcelable.Creator<ParcelableCollaborator> {
    static void a(ParcelableCollaborator parcelableCollaborator, Parcel parcel, int i) {
        int C = b.C(parcel);
        b.c(parcel, 1, parcelableCollaborator.xJ);
        b.a(parcel, 2, parcelableCollaborator.Lh);
        b.a(parcel, 3, parcelableCollaborator.Li);
        b.a(parcel, 4, parcelableCollaborator.rO, false);
        b.a(parcel, 5, parcelableCollaborator.Lj, false);
        b.a(parcel, 6, parcelableCollaborator.Lk, false);
        b.a(parcel, 7, parcelableCollaborator.Ll, false);
        b.a(parcel, 8, parcelableCollaborator.Lm, false);
        b.G(parcel, C);
    }
