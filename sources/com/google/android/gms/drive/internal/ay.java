...
public class ay implements Parcelable.Creator<UpdateMetadataRequest> {
    static void a(UpdateMetadataRequest updateMetadataRequest, Parcel parcel, int i) {
        int C = b.C(parcel);
        b.c(parcel, 1, updateMetadataRequest.xJ);
        b.a(parcel, 2, (Parcelable) updateMetadataRequest.Ir, i, false);
        b.a(parcel, 3, (Parcelable) updateMetadataRequest.Is, i, false);
        b.G(parcel, C);
    }
