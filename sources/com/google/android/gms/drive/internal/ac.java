...
public interface ac extends IInterface {
    ...
    public static abstract class a extends Binder implements ac {
        ...
        /* renamed from: com.google.android.gms.drive.internal.ac$a$a  reason: collision with other inner class name */
        private static class C0017a implements ac {
            private IBinder ko;
        ...
        public static ac R(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ac)) ? new C0017a(iBinder) : (ac) queryLocalInterface;
        }
