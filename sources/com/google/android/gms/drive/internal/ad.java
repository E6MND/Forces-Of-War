...
public class ad implements Parcelable.Creator<ListParentsRequest> {
    static void a(ListParentsRequest listParentsRequest, Parcel parcel, int i) {
        int C = b.C(parcel);
        b.c(parcel, 1, listParentsRequest.xJ);
        b.a(parcel, 2, (Parcelable) listParentsRequest.Jo, i, false);
        b.G(parcel, C);
    }
