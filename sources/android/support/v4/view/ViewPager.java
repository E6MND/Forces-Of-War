...
public class ViewPager extends ViewGroup {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(childWidthSize, PageTransition.CLIENT_REDIRECT);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(childHeightSize, PageTransition.CLIENT_REDIRECT);
        this.mInLayout = true;
        populate();
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), PageTransition.CLIENT_REDIRECT), this.mChildHeightMeasureSpec);
            }
        }
    }
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (!lp2.isDecor && (ii = infoForChild(child2)) != null) {
                    ...
                    if (lp2.needsMeasure) {
                        ...
                        child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp2.widthFactor), PageTransition.CLIENT_REDIRECT), View.MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, PageTransition.CLIENT_REDIRECT));
                    }
